...
from src.utils.utils import create_standard_indices
...
class OSMOverturePOIFusion:
    ...
    def run(self):
        ...
        sql_insert_poi_osm = f"""
            INSERT INTO temporal.poi_osm_{self.region}_fusion(category_1, name, street, housenumber, zipcode, opening_hours, wheelchair, tags, geom, id)
